...
export const deleteLivreur = () => {};
export const updateLivreur = () => {};
export const getOneLivreur = () => {};
export const getAllLivreur = () => {};
/****************************                   Livreur     **********
 *  */
/********************************** *          factures     */
export const GetOneFacture = () => {};
export const GetAllFacture = () => {};
export const UpdateStatuefacture = () => {};
export const UpdateInformationfacture = () => {};
